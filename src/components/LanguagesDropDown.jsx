...
export default function LanguagesDropDown ({languageDDActive}){
    ...
    return<>
    <div  className={`${ isLangActive ? 'block  translate-x-0 ' : 'hidden translate-x-full' } ${theme ? 'bg-black text-white' :'bg-sky-700'} z-20  w-full left-0 ease-in duration-200   md:w-[40%] min-h-screen pl-8 absolute md:left-[52%] md:max-h-[30rem] top-0 md:top-14 border   border-sky-900`}>
