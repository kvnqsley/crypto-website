...
// import {FaMoon,FaCaretDown, FaLevelDownAlt,FaSun} from 'react-icons/fa'
...
// import {toggleCurrency, toggleLanguages} from '../utils/LangSlice'
...
// export default function Navbar({isActive,handleToggle,theme}) {
...
// // useShowData(languageRef.current)


// // const dispatchEvent(toggleLanguages()=()=>{
...
//     </div>
//     <h4 className='flex-grow min-w-[15rem]'>CoinMamba</h4>
...
//     <li id={langId} className='cursor-pointer abc'  onClick={()=>dispatch(toggleLanguages())} ref={languageRef}>
//     <div className='cursor-pointer'>EN<FaCaretDown className='inline'/>
//         <LanguagesDropDown
//         languageDDActive={languageDDActive}
//         /></div>
//     </li>
//     <li ref={currencyRef}  className='cursor-pointer abcd'>
//     <div id={currencyId}
//       className='cursor-pointer'
//       onClick =  {()=>dispatch(toggleLanguages())} >{currency}
//        <FaCaretDown  className='inline'/></div>
//     <CurrencyDropDown 
...
//     className='cursor-pointer'>
//         {
//             theme ?  <FaMoon  className='inline'/> : <FaSun className='inline'/>
//         }
